...
public class Translation : ITranslation
{
    ...
    [Description("The text that shows in the embed description when the server has players online. players placeholder is the list of players using the player list translation.")]
