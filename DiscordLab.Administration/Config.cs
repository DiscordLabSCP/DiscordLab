...
public class Config
{
    ...
    [Description("The channel to send remote admin logs, command of which wasn't found.")]
    public ulong RemoteAdminNotFoundChannelId { get; set; } = 0;
    
    [Description("The channel to send normal command logs, command of which wasn't found.")]
    public ulong CommandNotFoundChannelId { get; set; } = 0;
