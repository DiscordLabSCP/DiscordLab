...
public class Translation : ITranslation
{
    ...
    [Description("The message that will be sent when a player dies by their own actions, or just they died because of something else.")]
    ...
    public string TeamKill { get; set; } = "`{player}` has been team-killed by `{attacker}`, they were both {role}.";
}